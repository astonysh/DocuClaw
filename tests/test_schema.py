from docuclaw.schema import DocuClawDocument, EntityType, SourceType, DocumentType
...
def test_id_generation_is_safe():
    ...
    doc1 = DocuClawDocument(
        entity_id="e1", entity_type=EntityType.PERSONAL, source_type=SourceType.MANUAL,
        country="US", document_type=DocumentType.OTHER, date_received=date.today(),
        sender_name="S1"
    )
